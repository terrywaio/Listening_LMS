...
Static intensive listening LMS package generated locally.

- Open `index.html` from GitHub Pages or a local static server.
- Course data is loaded from `library.json`.
